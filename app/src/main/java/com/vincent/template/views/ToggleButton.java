        ...
        extends View
{
     ...
     * 开启颜色
     */
    private int     onColor        = Color.parseColor("#1E6EFE");
    /**
     * 关闭颜色
     */
     ...
     * 灰色带颜色
     */
    private int     offColor       = Color.parseColor("#26314F");
    /**
     * 手柄颜色
     */
    ...
    public void setup(AttributeSet attrs) {
        ...
        offBorderColor = typedArray.getColor(R.styleable.ToggleButton_offBorderColor,
                                             offBorderColor);
        ...
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_toggle_border_width,
                                                       borderWidth);
        typedArray.recycle();
    }
    ...
    private void animateCheckedState(boolean newCheckedState) {
        ...
        if (mAnimator == null) {
            mAnimator = ObjectAnimator.ofObject(this,
                                                ANIM_VALUE,
                                                new AnimatorEvaluator(mCurProperty),
                                                property);
    ...
    private final static class AnimatorEvaluator
            implements TypeEvaluator<AnimatorProperty>
    {
        ...
        @Override
        public AnimatorProperty evaluate(float fraction,
                                         AnimatorProperty startValue,
                                         AnimatorProperty endValue)
        {
            // Values
            ...
            mProperty.color = (startA + (int) (fraction * (endA - startA))) << 24 | (startR + (int) (fraction * (endR - startR))) << 16 | (startG + (int) (fraction * (endG - startG))) << 8 | (startB + (int) (fraction * (endB - startB)));

            return mProperty;
        }
    }

    private final static Property<ToggleButton, AnimatorProperty> ANIM_VALUE = new Property<ToggleButton, AnimatorProperty>(
            AnimatorProperty.class,
            "animValue")
    {
        @Override
